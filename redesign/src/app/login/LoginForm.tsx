      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl shadow-xl p-8 transition-colors duration-200">
          ...
          <div className="text-center mb-8">
            <div className="text-3xl font-bold text-orange-500">{t.brand}</div>
            <div className="text-xs mt-1" style={{ color: 'var(--muted)' }}>{t.brandSub}</div>
          </div>

          <h1 className="text-xl font-semibold text-[var(--text)] mb-5">{t.loginTitle}</h1>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl bg-[var(--bg)] border ${
                hasError ? 'border-red-500' : 'border-[var(--border)]'
              } text-[var(--text)] placeholder-[var(--muted)] focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors duration-200`}
            />
            {hasError && (
          ...
          <div className="mb-2">
            <div className="flex justify-between items-center mb-1">
              ...
              <Link href="/forgot-password" className="text-sm text-orange-500 hover:text-orange-400 transition-colors duration-200">
                {t.forgotPassword}
              </Link>
            </div>
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pr-12 rounded-xl bg-[var(--bg)] border ${
                  hasError ? 'border-red-500' : 'border-[var(--border)]'
                } text-[var(--text)] placeholder-[var(--muted)] focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors duration-200`}
              />
              <button
                ...
                aria-label={showPassword ? t.toLight : t.toDark}
          ...
          <div className="text-right mb-6">
            <Link href="/register" className="text-sm text-orange-500 hover:text-orange-400 transition-colors duration-200">
              {t.register}
            </Link>
          </div>
          ...
          <button
            type="button"
            className="w-full py-3 px-4 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors duration-200 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 outline-none"
          >
            {t.loginBtn}
          </button>
          ...
          <div className="flex items-center my-6">
            ...
            <span className="mx-4 text-sm text-[var(--muted)]">{t.orContinue}</span>
            <div className="flex-1 border-t border-[var(--border)]" />
          </div>
